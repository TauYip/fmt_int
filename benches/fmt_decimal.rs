...
fn fmt_int_bench() {
    ...
    black_box(fmt_int!(i8::MAX));
    black_box(fmt_int!(i16::MAX));
    black_box(fmt_int!(i32::MAX));
    black_box(fmt_int!(i64::MAX));
    black_box(fmt_int!(i128::MAX));
    black_box(fmt_int!(isize::MAX));
    black_box(fmt_int!(i8::MIN));
    black_box(fmt_int!(i16::MIN));
    black_box(fmt_int!(i32::MIN));
    black_box(fmt_int!(i64::MIN));
    black_box(fmt_int!(i128::MIN));

    black_box(fmt_int!(u8::MAX));
    black_box(fmt_int!(u16::MAX));
    black_box(fmt_int!(u32::MAX));
    black_box(fmt_int!(u64::MAX));
    black_box(fmt_int!(u128::MAX));
}

fn bench(c: &mut Criterion) {
    c.benchmark_group("fmt_decimal")
